      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div 
            ...
            :key="equipment.id"
            class="group bg-white overflow-hidden hover-lift transition-all duration-300 hover:bg-slate-50 rounded-lg shadow-lg"
          ...
          >
            ...
            <div class="p-6">
              <div class="flex items-center justify-between mb-3">
                ...
                <span class="text-2xl font-bold text-slate-800">{{ equipment.price.toLocaleString() }} FCFA<span class="text-sm text-slate-500">/jour</span></span>
              </div>
